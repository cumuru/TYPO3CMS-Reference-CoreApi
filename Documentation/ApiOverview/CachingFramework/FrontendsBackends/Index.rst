...
usually flushed completely and does not need specific cache entry eviction. This backend does not support life times for cache entries. They do not expire until the cache is flushed manually.
